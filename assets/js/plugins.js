...
// Dayjs JS
document.writeln('<script src="assets/js/dayjs.min.js" type="text/javascript"></script>');

// Viewer JS
document.writeln('<script src="assets/js/viewer.min.js" type="text/javascript"></script>');

// Jquery-Viewer JS
document.writeln('<script src="assets/js/jquery-viewer.min.js" type="text/javascript"></script>');
