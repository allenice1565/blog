(function($) {
    'use strict';
     ...
     //语言下拉
            $(".hdENa").mouseover(function(){
                if ($('body').width()>992) {
                    $(this).next("div.NavEN").stop().show();
                }
                
            });
            $(".NavENk").mouseleave(function(){
                $(this).children("div.NavEN").stop().hide();
            });

            $(".wap-hdENa").click(function(){
                if (!$(this).hasClass('on')) {
                    $(this).addClass('on');
                    $(this).next("div.NavEN").stop().show();
                }else{
                    $(this).removeClass('on');
                    $(this).next("div.NavEN").stop().hide();
                }
            ...
            $(".nav-li").hover(function(){
                $(".bottomLine").css({"width" : parseFloat($(this).width())+"px" , "opacity" : 1});
    ...
    $('.edit-btn').on('click',function(){
        ...
        $('.modal-div-block').addClass('active');
    })
    //關閉地址彈窗
    $('.cancellation-btn').on('click',function(){
        $('.overlay').removeClass('active');
        $('.modal-div-block').removeClass('active');
    })
    ...
    $('.sub-nav-closed').click(function(){
        $(this).parents('.wap-sub-nav').eq(0).fadeOut();
    })
    ...
    $('.back-main-menu').click(function(){
        ...
        $(this).parents('.dropdown-menu').next('.mean-expand').removeClass('mean-clicked').text("+");
    })
